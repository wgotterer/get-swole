...
juliettepushups = OnlineClass.create(video:"https://youtu.be/4bqJSSLNJ3M", description:"Push up demontration from our most beloved trainer Juliette.", trainer_id:juliette.id, category:"Upper Body", name:"Push ups with Juliette")
...
brendanjumpingjacks = OnlineClass.create(video:'https://youtu.be/R0JtO-Wv3MY', description:'Learn how to do jumping jacks for cardio with Brendan', trainer_id:brendan.id, category:'Weight Loss', name:'Jumping Jacks with Brendan')
